// Code taken from https://raw.githubusercontent.com/victorcwai/rust-lox/main/src/scanner.rs
...
mod tests {
    ...
    fn lex_simple_statement() {
        ...
        loop {
            ...
            actual_tokens.push(token.lexeme);
        }
        assert_eq!(actual_tokens, vec!["var", "x", "=", "3"])
    }
}
